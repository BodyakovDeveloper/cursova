...
<form method="post" action="${pageContext.request.contextPath}/signup" modelAttribute="userToRegister">
    ...
    <input type="button" value="cancel" class="cancel" onclick="document.location.href='/login'">
</form>
</body>
</html>